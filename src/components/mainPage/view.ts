...
export default class ViewMainPage {
  drawMainBlock() {
    ...
    mainBlock.innerHTML = `<div class='main-block__content'>
                            ...
                            на распознование английской речи, где ты выберешь перевод услышанного слова.
  ...
  drawBenefits() {
    ...
    benefitCards.innerHTML = `<h3>Оцени преимущества приложения</h3>
                              <h4>Зарегистрируйся, чтобы использовать все возможности</h4>`;
